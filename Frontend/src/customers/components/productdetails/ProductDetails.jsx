    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  <Rating name="read-omly" value={4} readOnly />
                  <p className="opacity-60 text-sm">5625 Ratings</p>
                ...
                <h1 className="text-xl font-semibold pb-1" >Product Ratings</h1>
                  ...
                  <Box className="mt-3 space-y-3">
                    <Grid container alignItems="center" gap={2}>
                      ...
                      <Grid item xs={7}>
                        <LinearProgress sx={{bgcolor:"lightgray", borderRadius:4, height:7}} variant="determinate" value={40} color="success" />
                      </Grid>
                    </Grid>
                    ...
                    <Grid container alignItems="center" gap={2}>
                      ...
                      <Grid item xs={7}>
                        <LinearProgress sx={{bgcolor:"lightgray", borderRadius:4, height:7}} variant="determinate" value={30} color="info" />
                      </Grid>
                    </Grid>
                    ...
                    <Grid container alignItems="center" gap={2}>
                      ...
                      <Grid item xs={7}>
                        <LinearProgress sx={{bgcolor:"lightgray", borderRadius:4, height:7}} variant="determinate" value={25} color="secondary" />
                      </Grid>
                    </Grid>
                    ...
                    <Grid container alignItems="center" gap={2}>
                      ...
                      <Grid item xs={7}>
                        <LinearProgress sx={{bgcolor:"lightgray", borderRadius:4, height:7}} variant="determinate" value={20} color="warning" />
                      </Grid>
                    </Grid>
                    ...
                    <Grid container alignItems="center" gap={2}>
                      ...
                      <Grid item xs={7}>
                        <LinearProgress sx={{bgcolor:"lightgray", borderRadius:4, height:7}} variant="determinate" value={15} color="error" />
                      </Grid>
                    </Grid>
                  </Box>
              </Grid>
        ...
        <section className="pt-10">
          <h1 className="py-5 text-xl font-semibold flex justify-center">Related Products</h1>
