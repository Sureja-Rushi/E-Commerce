...
export const CANCLED_ORDER_REQUEST = 'CANCLED_ORDER_REQUEST';
export const CANCLED_ORDER_SUCCESS = 'CANCLED_ORDER_SUCCESS';
export const CANCLED_ORDER_FAILURE = 'CANCLED_ORDER_FAILURE';
